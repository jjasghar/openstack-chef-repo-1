#!/bin/bash -x
neutron net-create pppoe --router:external False --provider:physical_network pppoe --provider:network_type flat
...
neutron subnet-create flg-net --name flg-subnet --gateway 10.1.1.254 --dns-namservers 192.168.1.13 10.1.1.0/24
#
